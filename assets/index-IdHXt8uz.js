...
void main() {
	...
	const n = new Float32Array(Hn), r = new D(0, 1, 0); return new Cn({
		...
		`, blending: bn, depthTest: !1, depthWrite: !1
	})
} function Po() {
	return new Cn({
		name: "EquirectangularToCubeUV", uniforms: { envMap: { value: null } }, vertexShader: fa(), fragmentShader: `
	...
	return new Cn({
		name: "CubemapToCubeUV", uniforms: { envMap: { value: null }, flipEnvMap: { value: -1 } }, vertexShader: fa(), fragmentShader: `
	...
	`} function tp(i) { let e = new WeakMap, t = null; function n(o) { if (o && o.isTexture) { const l = o.mapping, c = l === Ns || l === Os, u = l === Ti || l === Ai; if (c || u) if (o.isRenderTargetTexture && o.needsPMREMUpdate === !0) { o.needsPMREMUpdate = !1; let d = e.get(o); return t === null && (t = new Ro(i)), d = c ? t.fromEquirectangular(o, d) : t.fromCubemap(o, d), e.set(o, d), d.texture } else { if (e.has(o)) return e.get(o).texture; { const d = o.image; if (c && d && d.height > 0 || u && d && r(d)) { t === null && (t = new Ro(i)); const f = c ? t.fromEquirectangular(o) : t.fromCubemap(o); return e.set(o, f), o.addEventListener("dispose", s), f.texture } else return null } } } return o } function r(o) { let l = 0; const c = 6; for (let u = 0; u < c; u++)o[u] !== void 0 && l++; return l === c } function s(o) { const l = o.target; l.removeEventListener("dispose", s); const c = e.get(l); c !== void 0 && (e.delete(l), c.dispose()) } function a() { e = new WeakMap, t !== null && (t.dispose(), t = null) } return { get: n, dispose: a } } function np(i) { const e = {}; function t(n) { if (e[n] !== void 0) return e[n]; let r; switch (n) { case "WEBGL_depth_texture": r = i.getExtension("WEBGL_depth_texture") || i.getExtension("MOZ_WEBGL_depth_texture") || i.getExtension("WEBKIT_WEBGL_depth_texture"); break; case "EXT_texture_filter_anisotropic": r = i.getExtension("EXT_texture_filter_anisotropic") || i.getExtension("MOZ_EXT_texture_filter_anisotropic") || i.getExtension("WEBKIT_EXT_texture_filter_anisotropic"); break; case "WEBGL_compressed_texture_s3tc": r = i.getExtension("WEBGL_compressed_texture_s3tc") || i.getExtension("MOZ_WEBGL_compressed_texture_s3tc") || i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc"); break; case "WEBGL_compressed_texture_pvrtc": r = i.getExtension("WEBGL_compressed_texture_pvrtc") || i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc"); break; default: r = i.getExtension(n) }return e[n] = r, r } return { has: function (n) { return t(n) !== null }, init: function (n) { n.isWebGL2 ? (t("EXT_color_buffer_float"), t("WEBGL_clip_cull_distance")) : (t("WEBGL_depth_texture"), t("OES_texture_float"), t("OES_texture_half_float"), t("OES_texture_half_float_linear"), t("OES_standard_derivatives"), t("OES_element_index_uint"), t("OES_vertex_array_object"), t("ANGLE_instanced_arrays")), t("OES_texture_float_linear"), t("EXT_color_buffer_half_float"), t("WEBGL_multisampled_render_to_texture") }, get: function (n) { const r = t(n); return r === null && console.warn("THREE.WebGLRenderer: " + n + " extension not supported."), r } } } function ip(i, e, t, n) { const r = {}, s = new WeakMap; function a(d) { const f = d.target; f.index !== null && e.remove(f.index); for (const _ in f.attributes) e.remove(f.attributes[_]); for (const _ in f.morphAttributes) { const g = f.morphAttributes[_]; for (let h = 0, p = g.length; h < p; h++)e.remove(g[h]) } f.removeEventListener("dispose", a), delete r[f.id]; const m = s.get(f); m && (e.remove(m), s.delete(f)), n.releaseStatesOfGeometry(f), f.isInstancedBufferGeometry === !0 && delete f._maxInstanceCount, t.memory.geometries-- } function o(d, f) { return r[f.id] === !0 || (f.addEventListener("dispose", a), r[f.id] = !0, t.memory.geometries++), f } function l(d) { const f = d.attributes; for (const _ in f) e.update(f[_], i.ARRAY_BUFFER); const m = d.morphAttributes; for (const _ in m) { const g = m[_]; for (let h = 0, p = g.length; h < p; h++)e.update(g[h], i.ARRAY_BUFFER) } } function c(d) { const f = [], m = d.index, _ = d.attributes.position; let g = 0; if (m !== null) { const b = m.array; g = m.version; for (let S = 0, T = b.length; S < T; S += 3) { const P = b[S + 0], R = b[S + 1], C = b[S + 2]; f.push(P, R, R, C, C, P) } } else if (_ !== void 0) { const b = _.array; g = _.version; for (let S = 0, T = b.length / 3 - 1; S < T; S += 3) { const P = S + 0, R = S + 1, C = S + 2; f.push(P, R, R, C, C, P) } } else return; const h = new (Ol(f) ? kl : Gl)(f, 1); h.version = g; const p = s.get(d); p && e.remove(p), s.set(d, h) } function u(d) { const f = s.get(d); if (f) { const m = d.index; m !== null && f.version < m.version && c(d) } else c(d); return s.get(d) } return { get: o, update: l, getWireframeAttribute: u } } function rp(i, e, t, n) { const r = n.isWebGL2; let s; function a(m) { s = m } let o, l; function c(m) { o = m.type, l = m.bytesPerElement } function u(m, _) { i.drawElements(s, _, o, m * l), t.update(_, s, 1) } function d(m, _, g) { if (g === 0) return; let h, p; if (r) h = i, p = "drawElementsInstanced"; else if (h = e.get("ANGLE_instanced_arrays"), p = "drawElementsInstancedANGLE", h === null) { console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays."); return } h[p](s, _, o, m * l, g), t.update(_, s, g) } function f(m, _, g) { if (g === 0) return; const h = e.get("WEBGL_multi_draw"); if (h === null) for (let p = 0; p < g; p++)this.render(m[p] / l, _[p]); else { h.multiDrawElementsWEBGL(s, _, 0, o, m, 0, g); let p = 0; for (let b = 0; b < g; b++)p += _[b]; t.update(p, s, 1) } } this.setMode = a, this.setIndex = c, this.render = u, this.renderInstances = d, this.renderMultiDraw = f } function sp(i) { const e = { geometries: 0, textures: 0 }, t = { frame: 0, calls: 0, triangles: 0, points: 0, lines: 0 }; function n(s, a, o) { switch (t.calls++, a) { case i.TRIANGLES: t.triangles += o * (s / 3); break; case i.LINES: t.lines += o * (s / 2); break; case i.LINE_STRIP: t.lines += o * (s - 1); break; case i.LINE_LOOP: t.lines += o * s; break; case i.POINTS: t.points += o * s; break; default: console.error("THREE.WebGLInfo: Unknown draw mode:", a); break } } function r() { t.calls = 0, t.triangles = 0, t.points = 0, t.lines = 0 } return { memory: e, render: t, programs: null, autoReset: !0, reset: r, update: n } } function ap(i, e) { return i[0] - e[0] } function op(i, e) { return Math.abs(e[1]) - Math.abs(i[1]) } function lp(i, e, t) { const n = {}, r = new Float32Array(8), s = new WeakMap, a = new ft, o = []; for (let c = 0; c < 8; c++)o[c] = [c, 0]; function l(c, u, d) { const f = c.morphTargetInfluences; if (e.isWebGL2 === !0) { const _ = u.morphAttributes.position || u.morphAttributes.normal || u.morphAttributes.color, g = _ !== void 0 ? _.length : 0; let h = s.get(u); if (h === void 0 || h.count !== g) { let k = function () { ne.dispose(), s.delete(u), u.removeEventListener("dispose", k) }; var m = k; h !== void 0 && h.texture.dispose(); const S = u.morphAttributes.position !== void 0, T = u.morphAttributes.normal !== void 0, P = u.morphAttributes.color !== void 0, R = u.morphAttributes.position || [], C = u.morphAttributes.normal || [], V = u.morphAttributes.color || []; let le = 0; S === !0 && (le = 1), T === !0 && (le = 2), P === !0 && (le = 3); let x = u.attributes.position.count * le, w = 1; x > e.maxTextureSize && (w = Math.ceil(x / e.maxTextureSize), x = e.maxTextureSize); const W = new Float32Array(x * w * 4 * g), ne = new zl(W, x, w, g); ne.type = dn, ne.needsUpdate = !0; const L = le * 4; for (let z = 0; z < g; z++) { const K = R[z], X = C[z], q = V[z], j = x * w * 4 * z; for (let ae = 0; ae < K.count; ae++) { const ue = ae * L; S === !0 && (a.fromBufferAttribute(K, ae), W[j + ue + 0] = a.x, W[j + ue + 1] = a.y, W[j + ue + 2] = a.z, W[j + ue + 3] = 0), T === !0 && (a.fromBufferAttribute(X, ae), W[j + ue + 4] = a.x, W[j + ue + 5] = a.y, W[j + ue + 6] = a.z, W[j + ue + 7] = 0), P === !0 && (a.fromBufferAttribute(q, ae), W[j + ue + 8] = a.x, W[j + ue + 9] = a.y, W[j + ue + 10] = a.z, W[j + ue + 11] = q.itemSize === 4 ? a.w : 1) } } h = { count: g, texture: ne, size: new De(x, w) }, s.set(u, h), u.addEventListener("dispose", k) } let p = 0; for (let S = 0; S < f.length; S++)p += f[S]; const b = u.morphTargetsRelative ? 1 : 1 - p; d.getUniforms().setValue(i, "morphTargetBaseInfluence", b), d.getUniforms().setValue(i, "morphTargetInfluences", f), d.getUniforms().setValue(i, "morphTargetsTexture", h.texture, t), d.getUniforms().setValue(i, "morphTargetsTextureSize", h.size) } else { const _ = f === void 0 ? 0 : f.length; let g = n[u.id]; if (g === void 0 || g.length !== _) { g = []; for (let T = 0; T < _; T++)g[T] = [T, 0]; n[u.id] = g } for (let T = 0; T < _; T++) { const P = g[T]; P[0] = T, P[1] = f[T] } g.sort(op); for (let T = 0; T < 8; T++)T < _ && g[T][1] ? (o[T][0] = g[T][0], o[T][1] = g[T][1]) : (o[T][0] = Number.MAX_SAFE_INTEGER, o[T][1] = 0); o.sort(ap); const h = u.morphAttributes.position, p = u.morphAttributes.normal; let b = 0; for (let T = 0; T < 8; T++) { const P = o[T], R = P[0], C = P[1]; R !== Number.MAX_SAFE_INTEGER && C ? (h && u.getAttribute("morphTarget" + T) !== h[R] && u.setAttribute("morphTarget" + T, h[R]), p && u.getAttribute("morphNormal" + T) !== p[R] && u.setAttribute("morphNormal" + T, p[R]), r[T] = C, b += C) : (h && u.hasAttribute("morphTarget" + T) === !0 && u.deleteAttribute("morphTarget" + T), p && u.hasAttribute("morphNormal" + T) === !0 && u.deleteAttribute("morphNormal" + T), r[T] = 0) } const S = u.morphTargetsRelative ? 1 : 1 - b; d.getUniforms().setValue(i, "morphTargetBaseInfluence", S), d.getUniforms().setValue(i, "morphTargetInfluences", r) } } return { update: l } } function cp(i, e, t, n) { let r = new WeakMap; function s(l) { const c = n.render.frame, u = l.geometry, d = e.get(l, u); if (r.get(d) !== c && (e.update(d), r.set(d, c)), l.isInstancedMesh && (l.hasEventListener("dispose", o) === !1 && l.addEventListener("dispose", o), r.get(l) !== c && (t.update(l.instanceMatrix, i.ARRAY_BUFFER), l.instanceColor !== null && t.update(l.instanceColor, i.ARRAY_BUFFER), r.set(l, c))), l.isSkinnedMesh) { const f = l.skeleton; r.get(f) !== c && (f.update(), r.set(f, c)) } return d } function a() { r = new WeakMap } function o(l) { const c = l.target; c.removeEventListener("dispose", o), t.remove(c.instanceMatrix), c.instanceColor !== null && t.remove(c.instanceColor) } return { update: s, dispose: a } } class jl extends Lt { constructor(e, t, n, r, s, a, o, l, c, u) { if (u = u !== void 0 ? u : Vn, u !== Vn && u !== wi) throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat"); n === void 0 && u === Vn && (n = yn), n === void 0 && u === wi && (n = kn), super(null, r, s, a, o, l, u, n, c), this.isDepthTexture = !0, this.image = { width: e, height: t }, this.magFilter = o !== void 0 ? o : Tt, this.minFilter = l !== void 0 ? l : Tt, this.flipY = !1, this.generateMipmaps = !1, this.compareFunction = null } copy(e) { return super.copy(e), this.compareFunction = e.compareFunction, this } toJSON(e) { const t = super.toJSON(e); return this.compareFunction !== null && (t.compareFunction = this.compareFunction), t } } const $l = new Lt, Kl = new jl(1, 1); Kl.compareFunction = Nl; const Zl = new zl, Jl = new Yu, Ql = new Xl, Uo = [], Io = [], No = new Float32Array(16), Oo = new Float32Array(9), Fo = new Float32Array(4); function Li(i, e, t) { const n = i[0]; if (n <= 0 || n > 0) return i; const r = e * t; let s = Uo[r]; if (s === void 0 && (s = new Float32Array(r), Uo[r] = s), e !== 0) { n.toArray(s, 0); for (let a = 1, o = 0; a !== e; ++a)o += t, i[a].toArray(s, o) } return s } function ct(i, e) { if (i.length !== e.length) return !1; for (let t = 0, n = i.length; t < n; t++)if (i[t] !== e[t]) return !1; return !0 } function ut(i, e) { for (let t = 0, n = e.length; t < n; t++)i[t] = e[t] } function qr(i, e) { let t = Io[e]; t === void 0 && (t = new Int32Array(e), Io[e] = t); for (let n = 0; n !== e; ++n)t[n] = i.allocateTextureUnit(); return t } function up(i, e) { const t = this.cache; t[0] !== e && (i.uniform1f(this.addr, e), t[0] = e) } function dp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y) && (i.uniform2f(this.addr, e.x, e.y), t[0] = e.x, t[1] = e.y); else { if (ct(t, e)) return; i.uniform2fv(this.addr, e), ut(t, e) } } function hp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y || t[2] !== e.z) && (i.uniform3f(this.addr, e.x, e.y, e.z), t[0] = e.x, t[1] = e.y, t[2] = e.z); else if (e.r !== void 0) (t[0] !== e.r || t[1] !== e.g || t[2] !== e.b) && (i.uniform3f(this.addr, e.r, e.g, e.b), t[0] = e.r, t[1] = e.g, t[2] = e.b); else { if (ct(t, e)) return; i.uniform3fv(this.addr, e), ut(t, e) } } function fp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y || t[2] !== e.z || t[3] !== e.w) && (i.uniform4f(this.addr, e.x, e.y, e.z, e.w), t[0] = e.x, t[1] = e.y, t[2] = e.z, t[3] = e.w); else { if (ct(t, e)) return; i.uniform4fv(this.addr, e), ut(t, e) } } function pp(i, e) { const t = this.cache, n = e.elements; if (n === void 0) { if (ct(t, e)) return; i.uniformMatrix2fv(this.addr, !1, e), ut(t, e) } else { if (ct(t, n)) return; Fo.set(n), i.uniformMatrix2fv(this.addr, !1, Fo), ut(t, n) } } function mp(i, e) { const t = this.cache, n = e.elements; if (n === void 0) { if (ct(t, e)) return; i.uniformMatrix3fv(this.addr, !1, e), ut(t, e) } else { if (ct(t, n)) return; Oo.set(n), i.uniformMatrix3fv(this.addr, !1, Oo), ut(t, n) } } function _p(i, e) { const t = this.cache, n = e.elements; if (n === void 0) { if (ct(t, e)) return; i.uniformMatrix4fv(this.addr, !1, e), ut(t, e) } else { if (ct(t, n)) return; No.set(n), i.uniformMatrix4fv(this.addr, !1, No), ut(t, n) } } function gp(i, e) { const t = this.cache; t[0] !== e && (i.uniform1i(this.addr, e), t[0] = e) } function vp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y) && (i.uniform2i(this.addr, e.x, e.y), t[0] = e.x, t[1] = e.y); else { if (ct(t, e)) return; i.uniform2iv(this.addr, e), ut(t, e) } } function xp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y || t[2] !== e.z) && (i.uniform3i(this.addr, e.x, e.y, e.z), t[0] = e.x, t[1] = e.y, t[2] = e.z); else { if (ct(t, e)) return; i.uniform3iv(this.addr, e), ut(t, e) } } function Ep(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y || t[2] !== e.z || t[3] !== e.w) && (i.uniform4i(this.addr, e.x, e.y, e.z, e.w), t[0] = e.x, t[1] = e.y, t[2] = e.z, t[3] = e.w); else { if (ct(t, e)) return; i.uniform4iv(this.addr, e), ut(t, e) } } function Sp(i, e) { const t = this.cache; t[0] !== e && (i.uniform1ui(this.addr, e), t[0] = e) } function yp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y) && (i.uniform2ui(this.addr, e.x, e.y), t[0] = e.x, t[1] = e.y); else { if (ct(t, e)) return; i.uniform2uiv(this.addr, e), ut(t, e) } } function Mp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y || t[2] !== e.z) && (i.uniform3ui(this.addr, e.x, e.y, e.z), t[0] = e.x, t[1] = e.y, t[2] = e.z); else { if (ct(t, e)) return; i.uniform3uiv(this.addr, e), ut(t, e) } } function bp(i, e) { const t = this.cache; if (e.x !== void 0) (t[0] !== e.x || t[1] !== e.y || t[2] !== e.z || t[3] !== e.w) && (i.uniform4ui(this.addr, e.x, e.y, e.z, e.w), t[0] = e.x, t[1] = e.y, t[2] = e.z, t[3] = e.w); else { if (ct(t, e)) return; i.uniform4uiv(this.addr, e), ut(t, e) } } function Tp(i, e, t) { const n = this.cache, r = t.allocateTextureUnit(); n[0] !== r && (i.uniform1i(this.addr, r), n[0] = r); const s = this.type === i.SAMPLER_2D_SHADOW ? Kl : $l; t.setTexture2D(e || s, r) } function Ap(i, e, t) { const n = this.cache, r = t.allocateTextureUnit(); n[0] !== r && (i.uniform1i(this.addr, r), n[0] = r), t.setTexture3D(e || Jl, r) } function wp(i, e, t) { const n = this.cache, r = t.allocateTextureUnit(); n[0] !== r && (i.uniform1i(this.addr, r), n[0] = r), t.setTextureCube(e || Ql, r) } function Cp(i, e, t) { const n = this.cache, r = t.allocateTextureUnit(); n[0] !== r && (i.uniform1i(this.addr, r), n[0] = r), t.setTexture2DArray(e || Zl, r) } function Rp(i) { switch (i) { case 5126: return up; case 35664: return dp; case 35665: return hp; case 35666: return fp; case 35674: return pp; case 35675: return mp; case 35676: return _p; case 5124: case 35670: return gp; case 35667: case 35671: return vp; case 35668: case 35672: return xp; case 35669: case 35673: return Ep; case 5125: return Sp; case 36294: return yp; case 36295: return Mp; case 36296: return bp; case 35678: case 36198: case 36298: case 36306: case 35682: return Tp; case 35679: case 36299: case 36307: return Ap; case 35680: case 36300: case 36308: case 36293: return wp; case 36289: case 36303: case 36311: case 36292: return Cp } } function Lp(i, e) { i.uniform1fv(this.addr, e) } function Pp(i, e) { const t = Li(e, this.size, 2); i.uniform2fv(this.addr, t) } function Dp(i, e) { const t = Li(e, this.size, 3); i.uniform3fv(this.addr, t) } function Up(i, e) { const t = Li(e, this.size, 4); i.uniform4fv(this.addr, t) } function Ip(i, e) { const t = Li(e, this.size, 4); i.uniformMatrix2fv(this.addr, !1, t) } function Np(i, e) { const t = Li(e, this.size, 9); i.uniformMatrix3fv(this.addr, !1, t) } function Op(i, e) { const t = Li(e, this.size, 16); i.uniformMatrix4fv(this.addr, !1, t) } function Fp(i, e) { i.uniform1iv(this.addr, e) } function Bp(i, e) { i.uniform2iv(this.addr, e) } function zp(i, e) { i.uniform3iv(this.addr, e) } function Hp(i, e) { i.uniform4iv(this.addr, e) } function Gp(i, e) { i.uniform1uiv(this.addr, e) } function kp(i, e) { i.uniform2uiv(this.addr, e) } function Vp(i, e) { i.uniform3uiv(this.addr, e) } function Wp(i, e) { i.uniform4uiv(this.addr, e) } function Xp(i, e, t) { const n = this.cache, r = e.length, s = qr(t, r); ct(n, s) || (i.uniform1iv(this.addr, s), ut(n, s)); for (let a = 0; a !== r; ++a)t.setTexture2D(e[a] || $l, s[a]) } function Yp(i, e, t) { const n = this.cache, r = e.length, s = qr(t, r); ct(n, s) || (i.uniform1iv(this.addr, s), ut(n, s)); for (let a = 0; a !== r; ++a)t.setTexture3D(e[a] || Jl, s[a]) } function qp(i, e, t) { const n = this.cache, r = e.length, s = qr(t, r); ct(n, s) || (i.uniform1iv(this.addr, s), ut(n, s)); for (let a = 0; a !== r; ++a)t.setTextureCube(e[a] || Ql, s[a]) } function jp(i, e, t) { const n = this.cache, r = e.length, s = qr(t, r); ct(n, s) || (i.uniform1iv(this.addr, s), ut(n, s)); for (let a = 0; a !== r; ++a)t.setTexture2DArray(e[a] || Zl, s[a]) } function $p(i) { switch (i) { case 5126: return Lp; case 35664: return Pp; case 35665: return Dp; case 35666: return Up; case 35674: return Ip; case 35675: return Np; case 35676: return Op; case 5124: case 35670: return Fp; case 35667: case 35671: return Bp; case 35668: case 35672: return zp; case 35669: case 35673: return Hp; case 5125: return Gp; case 36294: return kp; case 36295: return Vp; case 36296: return Wp; case 35678: case 36198: case 36298: case 36306: case 35682: return Xp; case 35679: case 36299: case 36307: return Yp; case 35680: case 36300: case 36308: case 36293: return qp; case 36289: case 36303: case 36311: case 36292: return jp } } class Kp { constructor(e, t, n) { this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = Rp(t.type) } } class Zp { constructor(e, t, n) { this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = $p(t.type) } } class Jp { constructor(e) { this.id = e, this.seq = [], this.map = {} } setValue(e, t, n) { const r = this.seq; for (let s = 0, a = r.length; s !== a; ++s) { const o = r[s]; o.setValue(e, t[o.id], n) } } } const As = /(\w+)(\])?(\[|\.)?/g; function Bo(i, e) { i.seq.push(e), i.map[e.id] = e } function Qp(i, e, t) { const n = i.name, r = n.length; for (As.lastIndex = 0; ;) { const s = As.exec(n), a = As.lastIndex; let o = s[1]; const l = s[2] === "]", c = s[3]; if (l && (o = o | 0), c === void 0 || c === "[" && a + 2 === r) { Bo(t, c === void 0 ? new Kp(o, i, e) : new Zp(o, i, e)); break } else { let d = t.map[o]; d === void 0 && (d = new Jp(o), Bo(t, d)), t = d } } } class Lr { constructor(e, t) { this.seq = [], this.map = {}; const n = e.getProgramParameter(t, e.ACTIVE_UNIFORMS); for (let r = 0; r < n; ++r) { const s = e.getActiveUniform(t, r), a = e.getUniformLocation(t, s.name); Qp(s, a, this) } } setValue(e, t, n, r) { const s = this.map[t]; s !== void 0 && s.setValue(e, n, r) } setOptional(e, t, n) { const r = t[n]; r !== void 0 && this.setValue(e, n, r) } static upload(e, t, n, r) { for (let s = 0, a = t.length; s !== a; ++s) { const o = t[s], l = n[o.id]; l.needsUpdate !== !1 && o.setValue(e, l.value, r) } } static seqWithValue(e, t) { const n = []; for (let r = 0, s = e.length; r !== s; ++r) { const a = e[r]; a.id in t && n.push(a) } return n } } function zo(i, e, t) { const n = i.createShader(e); return i.shaderSource(n, t), i.compileShader(n), n } const em = 37297; let tm = 0; function nm(i, e) {
	const t = i.split(`
`), n = [], r = Math.max(e - 6, 0), s = Math.min(e + 6, t.length); for (let a = r; a < s; a++) { const o = a + 1; n.push(`${o === e ? ">" : " "} ${o}: ${t[a]}`) } return n.join(`
`)
} function im(i) { const e = Ze.getPrimaries(Ze.workingColorSpace), t = Ze.getPrimaries(i); let n; switch (e === t ? n = "" : e === Ir && t === Ur ? n = "LinearDisplayP3ToLinearSRGB" : e === Ur && t === Ir && (n = "LinearSRGBToLinearDisplayP3"), i) { case fn: case kr: return [n, "LinearTransferOETF"]; case gt: case ca: return [n, "sRGBTransferOETF"]; default: return console.warn("THREE.WebGLProgram: Unsupported color space:", i), [n, "LinearTransferOETF"] } } function Ho(i, e, t) {
...
`+ nm(i.getShaderSource(e), a)
	} else return r
} function rm(i, e) { const t = im(e); return `vec4 ${i}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }` } function sm(i, e) { let t; switch (e) { case tu: t = "Linear"; break; case nu: t = "Reinhard"; break; case iu: t = "OptimizedCineon"; break; case ru: t = "ACESFilmic"; break; case au: t = "AgX"; break; case su: t = "Custom"; break; default: console.warn("THREE.WebGLProgram: Unsupported toneMapping:", e), t = "Linear" }return "vec3 " + i + "( vec3 color ) { return " + t + "ToneMapping( color ); }" } function am(i) {
...
`)
} function cm(i, e) { const t = {}, n = i.getProgramParameter(e, i.ACTIVE_ATTRIBUTES); for (let r = 0; r < n; r++) { const s = i.getActiveAttrib(e, r), a = s.name; let o = 1; s.type === i.FLOAT_MAT2 && (o = 2), s.type === i.FLOAT_MAT3 && (o = 3), s.type === i.FLOAT_MAT4 && (o = 4), t[a] = { type: s.type, location: i.getAttribLocation(e, a), locationSize: o } } return t } function vi(i) { return i !== "" } function Go(i, e) { const t = e.numSpotLightShadows + e.numSpotLightMaps - e.numSpotLightShadowsWithMaps; return i.replace(/NUM_DIR_LIGHTS/g, e.numDirLights).replace(/NUM_SPOT_LIGHTS/g, e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g, e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g, t).replace(/NUM_RECT_AREA_LIGHTS/g, e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g, e.numPointLights).replace(/NUM_HEMI_LIGHTS/g, e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g, e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g, e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g, e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g, e.numPointLightShadows) } function ko(i, e) { return i.replace(/NUM_CLIPPING_PLANES/g, e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g, e.numClippingPlanes - e.numClipIntersection) } const um = /^[ \t]*#include +<([\w\d./]+)>/gm; function Gs(i) { return i.replace(um, hm) } const dm = new Map([["encodings_fragment", "colorspace_fragment"], ["encodings_pars_fragment", "colorspace_pars_fragment"], ["output_fragment", "opaque_fragment"]]); function hm(i, e) { let t = Ge[e]; if (t === void 0) { const n = dm.get(e); if (n !== void 0) t = Ge[n], console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.', e, n); else throw new Error("Can not resolve #include <" + e + ">") } return Gs(t) } const fm = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g; function Vo(i) { return i.replace(fm, pm) } function pm(i, e, t, n) { let r = ""; for (let s = parseInt(e); s < parseInt(t); s++)r += n.replace(/\[\s*i\s*\]/g, "[ " + s + " ]").replace(/UNROLLED_LOOP_INDEX/g, s); return r } function Wo(i) {
...
} function mm(i) { let e = "SHADOWMAP_TYPE_BASIC"; return i.shadowMapType === Ml ? e = "SHADOWMAP_TYPE_PCF" : i.shadowMapType === bl ? e = "SHADOWMAP_TYPE_PCF_SOFT" : i.shadowMapType === cn && (e = "SHADOWMAP_TYPE_VSM"), e } function _m(i) { let e = "ENVMAP_TYPE_CUBE"; if (i.envMap) switch (i.envMapMode) { case Ti: case Ai: e = "ENVMAP_TYPE_CUBE"; break; case Gr: e = "ENVMAP_TYPE_CUBE_UV"; break }return e } function gm(i) { let e = "ENVMAP_MODE_REFLECTION"; if (i.envMap) switch (i.envMapMode) { case Ai: e = "ENVMAP_MODE_REFRACTION"; break }return e } function vm(i) { let e = "ENVMAP_BLENDING_NONE"; if (i.envMap) switch (i.combine) { case Tl: e = "ENVMAP_BLENDING_MULTIPLY"; break; case Qc: e = "ENVMAP_BLENDING_MIX"; break; case eu: e = "ENVMAP_BLENDING_ADD"; break }return e } function xm(i) { const e = i.envMapCubeUVHeight; if (e === null) return null; const t = Math.log2(e) - 2, n = 1 / e; return { texelWidth: 1 / (3 * Math.max(Math.pow(2, t), 7 * 16)), texelHeight: n, maxMip: t } } function Em(i, e, t, n) {
	const r = i.getContext(), s = t.defines; let a = t.vertexShader, o = t.fragmentShader; const l = mm(t), c = _m(t), u = gm(t), d = vm(t), f = xm(t), m = t.isWebGL2 ? "" : am(t), _ = om(t), g = lm(s), h = r.createProgram(); let p, b, S = t.glslVersion ? "#version " + t.glslVersion + `
...
</div>`, w_ = function (e, t) { var n = e[t]; return Y.isArray(arguments[2]) || Y.isObject(arguments[2]) ? new E_(e, t, arguments[2]) : Y.isNumber(n) ? Y.isNumber(arguments[2]) && Y.isNumber(arguments[3]) ? Y.isNumber(arguments[4]) ? new Xs(e, t, arguments[2], arguments[3], arguments[4]) : new Xs(e, t, arguments[2], arguments[3]) : Y.isNumber(arguments[4]) ? new zr(e, t, { min: arguments[2], max: arguments[3], step: arguments[4] }) : new zr(e, t, { min: arguments[2], max: arguments[3] }) : Y.isString(n) ? new S_(e, t) : Y.isFunction(n) ? new lc(e, t, "") : Y.isBoolean(n) ? new ac(e, t) : null }; function C_(i) { setTimeout(i, 1e3 / 60) } var R_ = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || C_, L_ = function () { function i() { jt(this, i), this.backgroundElement = document.createElement("div"), Y.extend(this.backgroundElement.style, { backgroundColor: "rgba(0,0,0,0.8)", top: 0, left: 0, display: "none", zIndex: "1000", opacity: 0, WebkitTransition: "opacity 0.2s linear", transition: "opacity 0.2s linear" }), O.makeFullscreen(this.backgroundElement), this.backgroundElement.style.position = "fixed", this.domElement = document.createElement("div"), Y.extend(this.domElement.style, { position: "fixed", display: "none", zIndex: "1001", opacity: 0, WebkitTransition: "-webkit-transform 0.2s ease-out, opacity 0.2s linear", transition: "transform 0.2s ease-out, opacity 0.2s linear" }), document.body.appendChild(this.backgroundElement), document.body.appendChild(this.domElement); var e = this; O.bind(this.backgroundElement, "click", function () { e.hide() }) } return $t(i, [{ key: "show", value: function () { var t = this; this.backgroundElement.style.display = "block", this.domElement.style.display = "block", this.domElement.style.opacity = 0, this.domElement.style.webkitTransform = "scale(1.1)", this.layout(), Y.defer(function () { t.backgroundElement.style.opacity = 1, t.domElement.style.opacity = 1, t.domElement.style.webkitTransform = "scale(1)" }) } }, { key: "hide", value: function () { var t = this, n = function r() { t.domElement.style.display = "none", t.backgroundElement.style.display = "none", O.unbind(t.domElement, "webkitTransitionEnd", r), O.unbind(t.domElement, "transitionend", r), O.unbind(t.domElement, "oTransitionEnd", r) }; O.bind(this.domElement, "webkitTransitionEnd", n), O.bind(this.domElement, "transitionend", n), O.bind(this.domElement, "oTransitionEnd", n), this.backgroundElement.style.opacity = 0, this.domElement.style.opacity = 0, this.domElement.style.webkitTransform = "scale(1.1)" } }, { key: "layout", value: function () { this.domElement.style.left = window.innerWidth / 2 - O.getWidth(this.domElement) / 2 + "px", this.domElement.style.top = window.innerHeight / 2 - O.getHeight(this.domElement) / 2 + "px" } }]), i }(), P_ = m_(`.dg ul{list-style:none;margin:0;padding:0;width:100%;clear:both}.dg.ac{position:fixed;top:0;left:0;right:0;height:0;z-index:0}.dg:not(.ac) .main{overflow:hidden}.dg.main{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear}.dg.main.taller-than-window{overflow-y:auto}.dg.main.taller-than-window .close-button{opacity:1;margin-top:-1px;border-top:1px solid #2c2c2c}.dg.main ul.closed .close-button{opacity:1 !important}.dg.main:hover .close-button,.dg.main .close-button.drag{opacity:1}.dg.main .close-button{-webkit-transition:opacity .1s linear;-o-transition:opacity .1s linear;-moz-transition:opacity .1s linear;transition:opacity .1s linear;border:0;line-height:19px;height:20px;cursor:pointer;text-align:center;background-color:#000}.dg.main .close-button.close-top{position:relative}.dg.main .close-button.close-bottom{position:absolute}.dg.main .close-button:hover{background-color:#111}.dg.a{float:right;margin-right:15px;overflow-y:visible}.dg.a.has-save>ul.close-top{margin-top:0}.dg.a.has-save>ul.close-bottom{margin-top:27px}.dg.a.has-save>ul.closed{margin-top:0}.dg.a .save-row{top:0;z-index:1002}.dg.a .save-row.close-top{position:relative}.dg.a .save-row.close-bottom{position:fixed}.dg li{-webkit-transition:height .1s ease-out;-o-transition:height .1s ease-out;-moz-transition:height .1s ease-out;transition:height .1s ease-out;-webkit-transition:overflow .1s linear;-o-transition:overflow .1s linear;-moz-transition:overflow .1s linear;transition:overflow .1s linear}.dg li:not(.folder){cursor:auto;height:27px;line-height:27px;padding:0 4px 0 5px}.dg li.folder{padding:0;border-left:4px solid rgba(0,0,0,0)}.dg li.title{cursor:pointer;margin-left:-4px}.dg .closed li:not(.title),.dg .closed ul li,.dg .closed ul li>*{height:0;overflow:hidden;border:0}.dg .cr{clear:both;padding-left:3px;height:27px;overflow:hidden}.dg .property-name{cursor:default;float:left;clear:left;width:40%;overflow:hidden;text-overflow:ellipsis}.dg .cr.function .property-name{width:100%}.dg .c{float:left;width:60%;position:relative}.dg .c input[type=text]{border:0;margin-top:4px;padding:3px;width:100%;float:right}.dg .has-slider input[type=text]{width:30%;margin-left:0}.dg .slider{float:left;width:66%;margin-left:-5px;margin-right:0;height:19px;margin-top:4px}.dg .slider-fg{height:100%}.dg .c input[type=checkbox]{margin-top:7px}.dg .c select{margin-top:5px}.dg .cr.function,.dg .cr.function .property-name,.dg .cr.function *,.dg .cr.boolean,.dg .cr.boolean *{cursor:pointer}.dg .cr.color{overflow:visible}.dg .selector{display:none;position:absolute;margin-left:-9px;margin-top:23px;z-index:10}.dg .c:hover .selector,.dg .selector.drag{display:block}.dg li.save-row{padding:0}.dg li.save-row .button{display:inline-block;padding:0px 6px}.dg.dialogue{background-color:#222;width:460px;padding:15px;font-size:13px;line-height:15px}#dg-new-constructor{padding:10px;color:#222;font-family:Monaco, monospace;font-size:10px;border:0;resize:none;box-shadow:inset 1px 1px 1px #888;word-wrap:break-word;margin:12px 0;display:block;width:440px;overflow-y:scroll;height:100px;position:relative}#dg-local-explain{display:none;font-size:11px;line-height:17px;border-radius:3px;background-color:#333;padding:8px;margin-top:10px}#dg-local-explain code{font-size:10px}#dat-gui-save-locally{display:none}.dg{color:#eee;font:11px 'Lucida Grande', sans-serif;text-shadow:0 -1px 0 #111}.dg.main::-webkit-scrollbar{width:5px;background:#1a1a1a}.dg.main::-webkit-scrollbar-corner{height:0;display:none}.dg.main::-webkit-scrollbar-thumb{border-radius:5px;background:#676767}.dg li:not(.folder){background:#1a1a1a;border-bottom:1px solid #2c2c2c}.dg li.save-row{line-height:25px;background:#dad5cb;border:0}.dg li.save-row select{margin-left:5px;width:108px}.dg li.save-row .button{margin-left:5px;margin-top:1px;border-radius:2px;font-size:9px;line-height:7px;padding:4px 4px 5px 4px;background:#c5bdad;color:#fff;text-shadow:0 1px 0 #b0a58f;box-shadow:0 -1px 0 #b0a58f;cursor:pointer}.dg li.save-row .button.gears{background:#c5bdad url(data:image/png;base64,) 2px 1px no-repeat;height:7px;width:8px}.dg li.save-row .button:hover{background-color:#bab19e;box-shadow:0 -1px 0 #b0a58f}.dg li.folder{border-bottom:0}.dg li.title{padding-left:16px;background:#000 url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlI+hKgFxoCgAOw==) 6px 10px no-repeat;cursor:pointer;border-bottom:1px solid rgba(255,255,255,0.2)}.dg .closed li.title{background-image:url(data:image/gif;base64,R0lGODlhBQAFAJEAAP////Pz8////////yH5BAEAAAIALAAAAAAFAAUAAAIIlGIWqMCbWAEAOw==)}.dg .cr.boolean{border-left:3px solid #806787}.dg .cr.color{border-left:3px solid}.dg .cr.function{border-left:3px solid #e61d5f}.dg .cr.number{border-left:3px solid #2FA1D6}.dg .cr.number input[type=text]{color:#2FA1D6}.dg .cr.string{border-left:3px solid #1ed36f}.dg .cr.string input[type=text]{color:#1ed36f}.dg .cr.function:hover,.dg .cr.boolean:hover{background:#111}.dg .c input[type=text]{background:#303030;outline:none}.dg .c input[type=text]:hover{background:#3c3c3c}.dg .c input[type=text]:focus{background:#494949;color:#fff}.dg .c .slider{background:#303030;cursor:ew-resize}.dg .c .slider-fg{background:#2FA1D6;max-width:100%}.dg .c .slider:hover{background:#3c3c3c}.dg .c .slider:hover .slider-fg{background:#44abda}
`); T_.inject(P_); var _l = "dg", gl = 72, vl = 20, qi = "Default", Hi = function () { try { return !!window.localStorage } catch { return !1 } }(), ki = void 0, xl = !0, mi = void 0, Ds = !1, cc = [], Qe = function i(e) { var t = this, n = e || {}; this.domElement = document.createElement("div"), this.__ul = document.createElement("ul"), this.domElement.appendChild(this.__ul), O.addClass(this.domElement, _l), this.__folders = {}, this.__controllers = [], this.__rememberedObjects = [], this.__rememberedObjectIndecesToControllers = [], this.__listening = [], n = Y.defaults(n, { closeOnTop: !1, autoPlace: !0, width: i.DEFAULT_WIDTH }), n = Y.defaults(n, { resizable: n.autoPlace, hideable: n.autoPlace }), Y.isUndefined(n.load) ? n.load = { preset: qi } : n.preset && (n.load.preset = n.preset), Y.isUndefined(n.parent) && n.hideable && cc.push(this), n.resizable = Y.isUndefined(n.parent) && n.resizable, n.autoPlace && Y.isUndefined(n.scrollable) && (n.scrollable = !0); var r = Hi && localStorage.getItem(_i(this, "isLocal")) === "true", s = void 0, a = void 0; if (Object.defineProperties(this, { parent: { get: function () { return n.parent } }, scrollable: { get: function () { return n.scrollable } }, autoPlace: { get: function () { return n.autoPlace } }, closeOnTop: { get: function () { return n.closeOnTop } }, preset: { get: function () { return t.parent ? t.getRoot().preset : n.load.preset }, set: function (f) { t.parent ? t.getRoot().preset = f : n.load.preset = f, N_(this), t.revert() } }, width: { get: function () { return n.width }, set: function (f) { n.width = f, $s(t, f) } }, name: { get: function () { return n.name }, set: function (f) { n.name = f, a && (a.innerHTML = n.name) } }, closed: { get: function () { return n.closed }, set: function (f) { n.closed = f, n.closed ? O.addClass(t.__ul, i.CLASS_CLOSED) : O.removeClass(t.__ul, i.CLASS_CLOSED), this.onResize(), t.__closeButton && (t.__closeButton.innerHTML = f ? i.TEXT_OPEN : i.TEXT_CLOSED) } }, load: { get: function () { return n.load } }, useLocalStorage: { get: function () { return r }, set: function (f) { Hi && (r = f, f ? O.bind(window, "unload", s) : O.unbind(window, "unload", s), localStorage.setItem(_i(t, "isLocal"), f)) } } }), Y.isUndefined(n.parent)) { if (this.closed = n.closed || !1, O.addClass(this.domElement, i.CLASS_MAIN), O.makeSelectable(this.domElement, !1), Hi && r) { t.useLocalStorage = !0; var o = localStorage.getItem(_i(this, "gui")); o && (n.load = JSON.parse(o)) } this.__closeButton = document.createElement("div"), this.__closeButton.innerHTML = i.TEXT_CLOSED, O.addClass(this.__closeButton, i.CLASS_CLOSE_BUTTON), n.closeOnTop ? (O.addClass(this.__closeButton, i.CLASS_CLOSE_TOP), this.domElement.insertBefore(this.__closeButton, this.domElement.childNodes[0])) : (O.addClass(this.__closeButton, i.CLASS_CLOSE_BOTTOM), this.domElement.appendChild(this.__closeButton)), O.bind(this.__closeButton, "click", function () { t.closed = !t.closed }) } else { n.closed === void 0 && (n.closed = !0); var l = document.createTextNode(n.name); O.addClass(l, "controller-name"), a = _a(t, l); var c = function (f) { return f.preventDefault(), t.closed = !t.closed, !1 }; O.addClass(this.__ul, i.CLASS_CLOSED), O.addClass(a, "title"), O.bind(a, "click", c), n.closed || (this.closed = !1) } n.autoPlace && (Y.isUndefined(n.parent) && (xl && (mi = document.createElement("div"), O.addClass(mi, _l), O.addClass(mi, i.CLASS_AUTO_PLACE_CONTAINER), document.body.appendChild(mi), xl = !1), mi.appendChild(this.domElement), O.addClass(this.domElement, i.CLASS_AUTO_PLACE)), this.parent || $s(t, n.width)), this.__resizeHandler = function () { t.onResizeDebounced() }, O.bind(window, "resize", this.__resizeHandler), O.bind(this.__ul, "webkitTransitionEnd", this.__resizeHandler), O.bind(this.__ul, "transitionend", this.__resizeHandler), O.bind(this.__ul, "oTransitionEnd", this.__resizeHandler), this.onResize(), n.resizable && I_(this), s = function () { Hi && localStorage.getItem(_i(t, "isLocal")) === "true" && localStorage.setItem(_i(t, "gui"), JSON.stringify(t.getSaveObject())) }, this.saveToLocalStorageIfPossible = s; function u() { var d = t.getRoot(); d.width += 1, Y.defer(function () { d.width -= 1 }) } n.parent || u() }; Qe.toggleHide = function () { Ds = !Ds, Y.each(cc, function (i) { i.domElement.style.display = Ds ? "none" : "" }) }; Qe.CLASS_AUTO_PLACE = "a"; Qe.CLASS_AUTO_PLACE_CONTAINER = "ac"; Qe.CLASS_MAIN = "main"; Qe.CLASS_CONTROLLER_ROW = "cr"; Qe.CLASS_TOO_TALL = "taller-than-window"; Qe.CLASS_CLOSED = "closed"; Qe.CLASS_CLOSE_BUTTON = "close-button"; Qe.CLASS_CLOSE_TOP = "close-top"; Qe.CLASS_CLOSE_BOTTOM = "close-bottom"; Qe.CLASS_DRAG = "drag"; Qe.DEFAULT_WIDTH = 245; Qe.TEXT_CLOSED = "Close Controls"; Qe.TEXT_OPEN = "Open Controls"; Qe._keydownHandler = function (i) { document.activeElement.type !== "text" && (i.which === gl || i.keyCode === gl) && Qe.toggleHide() }; O.bind(window, "keydown", Qe._keydownHandler, !1); Y.extend(Qe.prototype, { add: function (e, t) { return Vi(this, e, t, { factoryArgs: Array.prototype.slice.call(arguments, 2) }) }, addColor: function (e, t) { return Vi(this, e, t, { color: !0 }) }, remove: function (e) { this.__ul.removeChild(e.__li), this.__controllers.splice(this.__controllers.indexOf(e), 1); var t = this; Y.defer(function () { t.onResize() }) }, destroy: function () { if (this.parent) throw new Error("Only the root GUI should be removed with .destroy(). For subfolders, use gui.removeFolder(folder) instead."); this.autoPlace && mi.removeChild(this.domElement); var e = this; Y.each(this.__folders, function (t) { e.removeFolder(t) }), O.unbind(window, "keydown", Qe._keydownHandler, !1), El(this) }, addFolder: function (e) { if (this.__folders[e] !== void 0) throw new Error('You already have a folder in this GUI by the name "' + e + '"'); var t = { name: e, parent: this }; t.autoPlace = this.autoPlace, this.load && this.load.folders && this.load.folders[e] && (t.closed = this.load.folders[e].closed, t.load = this.load.folders[e]); var n = new Qe(t); this.__folders[e] = n; var r = _a(this, n.domElement); return O.addClass(r, "folder"), n }, removeFolder: function (e) { this.__ul.removeChild(e.domElement.parentElement), delete this.__folders[e.name], this.load && this.load.folders && this.load.folders[e.name] && delete this.load.folders[e.name], El(e); var t = this; Y.each(e.__folders, function (n) { e.removeFolder(n) }), Y.defer(function () { t.onResize() }) }, open: function () { this.closed = !1 }, close: function () { this.closed = !0 }, hide: function () { this.domElement.style.display = "none" }, show: function () { this.domElement.style.display = "" }, onResize: function () { var e = this.getRoot(); if (e.scrollable) { var t = O.getOffset(e.__ul).top, n = 0; Y.each(e.__ul.childNodes, function (r) { e.autoPlace && r === e.__save_row || (n += O.getHeight(r)) }), window.innerHeight - t - vl < n ? (O.addClass(e.domElement, Qe.CLASS_TOO_TALL), e.__ul.style.height = window.innerHeight - t - vl + "px") : (O.removeClass(e.domElement, Qe.CLASS_TOO_TALL), e.__ul.style.height = "auto") } e.__resize_handle && Y.defer(function () { e.__resize_handle.style.height = e.__ul.offsetHeight + "px" }), e.__closeButton && (e.__closeButton.style.width = e.width + "px") }, onResizeDebounced: Y.debounce(function () { this.onResize() }, 50), remember: function () { if (Y.isUndefined(ki) && (ki = new L_, ki.domElement.innerHTML = A_), this.parent) throw new Error("You can only call remember on a top level GUI."); var e = this; Y.each(Array.prototype.slice.call(arguments), function (t) { e.__rememberedObjects.length === 0 && U_(e), e.__rememberedObjects.indexOf(t) === -1 && e.__rememberedObjects.push(t) }), this.autoPlace && $s(this, this.width) }, getRoot: function () { for (var e = this; e.parent;)e = e.parent; return e }, getSaveObject: function () { var e = this.load; return e.closed = this.closed, this.__rememberedObjects.length > 0 && (e.preset = this.preset, e.remembered || (e.remembered = {}), e.remembered[this.preset] = wr(this)), e.folders = {}, Y.each(this.__folders, function (t, n) { e.folders[n] = t.getSaveObject() }), e }, save: function () { this.load.remembered || (this.load.remembered = {}), this.load.remembered[this.preset] = wr(this), qs(this, !1), this.saveToLocalStorageIfPossible() }, saveAs: function (e) { this.load.remembered || (this.load.remembered = {}, this.load.remembered[qi] = wr(this, !0)), this.load.remembered[e] = wr(this), this.preset = e, js(this, e, !0), this.saveToLocalStorageIfPossible() }, revert: function (e) { Y.each(this.__controllers, function (t) { this.getRoot().load.remembered ? uc(e || this.getRoot(), t) : t.setValue(t.initialValue), t.__onFinishChange && t.__onFinishChange.call(t, t.getValue()) }, this), Y.each(this.__folders, function (t) { t.revert(t) }), e || qs(this.getRoot(), !1) }, listen: function (e) { var t = this.__listening.length === 0; this.__listening.push(e), t && dc(this.__listening) }, updateDisplay: function () { Y.each(this.__controllers, function (e) { e.updateDisplay() }), Y.each(this.__folders, function (e) { e.updateDisplay() }) } }); function _a(i, e, t) { var n = document.createElement("li"); return e && n.appendChild(e), t ? i.__ul.insertBefore(n, t) : i.__ul.appendChild(n), i.onResize(), n } function El(i) { O.unbind(window, "resize", i.__resizeHandler), i.saveToLocalStorageIfPossible && O.unbind(window, "unload", i.saveToLocalStorageIfPossible) } function qs(i, e) { var t = i.__preset_select[i.__preset_select.selectedIndex]; e ? t.innerHTML = t.value + "*" : t.innerHTML = t.value } function D_(i, e, t) { if (t.__li = e, t.__gui = i, Y.extend(t, { options: function (a) { if (arguments.length > 1) { var o = t.__li.nextElementSibling; return t.remove(), Vi(i, t.object, t.property, { before: o, factoryArgs: [Y.toArray(arguments)] }) } if (Y.isArray(a) || Y.isObject(a)) { var l = t.__li.nextElementSibling; return t.remove(), Vi(i, t.object, t.property, { before: l, factoryArgs: [a] }) } }, name: function (a) { return t.__li.firstElementChild.firstElementChild.innerHTML = a, t }, listen: function () { return t.__gui.listen(t), t }, remove: function () { return t.__gui.remove(t), t } }), t instanceof Xs) { var n = new zr(t.object, t.property, { min: t.__min, max: t.__max, step: t.__step }); Y.each(["updateDisplay", "onChange", "onFinishChange", "step", "min", "max"], function (s) { var a = t[s], o = n[s]; t[s] = n[s] = function () { var l = Array.prototype.slice.call(arguments); return o.apply(n, l), a.apply(t, l) } }), O.addClass(e, "has-slider"), t.domElement.insertBefore(n.domElement, t.domElement.firstElementChild) } else if (t instanceof zr) { var r = function (a) { if (Y.isNumber(t.__min) && Y.isNumber(t.__max)) { var o = t.__li.firstElementChild.firstElementChild.innerHTML, l = t.__gui.__listening.indexOf(t) > -1; t.remove(); var c = Vi(i, t.object, t.property, { before: t.__li.nextElementSibling, factoryArgs: [t.__min, t.__max, t.__step] }); return c.name(o), l && c.listen(), c } return a }; t.min = Y.compose(r, t.min), t.max = Y.compose(r, t.max) } else t instanceof ac ? (O.bind(e, "click", function () { O.fakeEvent(t.__checkbox, "click") }), O.bind(t.__checkbox, "click", function (s) { s.stopPropagation() })) : t instanceof lc ? (O.bind(e, "click", function () { O.fakeEvent(t.__button, "click") }), O.bind(e, "mouseover", function () { O.addClass(t.__button, "hover") }), O.bind(e, "mouseout", function () { O.removeClass(t.__button, "hover") })) : t instanceof Ys && (O.addClass(e, "color"), t.updateDisplay = Y.compose(function (s) { return e.style.borderLeftColor = t.__color.toString(), s }, t.updateDisplay), t.updateDisplay()); t.setValue = Y.compose(function (s) { return i.getRoot().__preset_select && t.isModified() && qs(i.getRoot(), !0), s }, t.setValue) } function uc(i, e) { var t = i.getRoot(), n = t.__rememberedObjects.indexOf(e.object); if (n !== -1) { var r = t.__rememberedObjectIndecesToControllers[n]; if (r === void 0 && (r = {}, t.__rememberedObjectIndecesToControllers[n] = r), r[e.property] = e, t.load && t.load.remembered) { var s = t.load.remembered, a = void 0; if (s[i.preset]) a = s[i.preset]; else if (s[qi]) a = s[qi]; else return; if (a[n] && a[n][e.property] !== void 0) { var o = a[n][e.property]; e.initialValue = o, e.setValue(o) } } } } function Vi(i, e, t, n) { if (e[t] === void 0) throw new Error('Object "' + e + '" has no property "' + t + '"'); var r = void 0; if (n.color) r = new Ys(e, t); else { var s = [e, t].concat(n.factoryArgs); r = w_.apply(i, s) } n.before instanceof $n && (n.before = n.before.__li), uc(i, r), O.addClass(r.domElement, "c"); var a = document.createElement("span"); O.addClass(a, "property-name"), a.innerHTML = r.property; var o = document.createElement("div"); o.appendChild(a), o.appendChild(r.domElement); var l = _a(i, o, n.before); return O.addClass(l, Qe.CLASS_CONTROLLER_ROW), r instanceof Ys ? O.addClass(l, "color") : O.addClass(l, g_(r.getValue())), D_(i, l, r), i.__controllers.push(r), r } function _i(i, e) { return document.location.href + "." + e } function js(i, e, t) { var n = document.createElement("option"); n.innerHTML = e, n.value = e, i.__preset_select.appendChild(n), t && (i.__preset_select.selectedIndex = i.__preset_select.length - 1) } function Sl(i, e) { e.style.display = i.useLocalStorage ? "block" : "none" } function U_(i) { var e = i.__save_row = document.createElement("li"); O.addClass(i.domElement, "has-save"), i.__ul.insertBefore(e, i.__ul.firstChild), O.addClass(e, "save-row"); var t = document.createElement("span"); t.innerHTML = "&nbsp;", O.addClass(t, "button gears"); var n = document.createElement("span"); n.innerHTML = "Save", O.addClass(n, "button"), O.addClass(n, "save"); var r = document.createElement("span"); r.innerHTML = "New", O.addClass(r, "button"), O.addClass(r, "save-as"); var s = document.createElement("span"); s.innerHTML = "Revert", O.addClass(s, "button"), O.addClass(s, "revert"); var a = i.__preset_select = document.createElement("select"); if (i.load && i.load.remembered ? Y.each(i.load.remembered, function (d, f) { js(i, f, f === i.preset) }) : js(i, qi, !1), O.bind(a, "change", function () { for (var d = 0; d < i.__preset_select.length; d++)i.__preset_select[d].innerHTML = i.__preset_select[d].value; i.preset = this.value }), e.appendChild(a), e.appendChild(t), e.appendChild(n), e.appendChild(r), e.appendChild(s), Hi) { var o = document.getElementById("dg-local-explain"), l = document.getElementById("dg-local-storage"), c = document.getElementById("dg-save-locally"); c.style.display = "block", localStorage.getItem(_i(i, "isLocal")) === "true" && l.setAttribute("checked", "checked"), Sl(i, o), O.bind(l, "change", function () { i.useLocalStorage = !i.useLocalStorage, Sl(i, o) }) } var u = document.getElementById("dg-new-constructor"); O.bind(u, "keydown", function (d) { d.metaKey && (d.which === 67 || d.keyCode === 67) && ki.hide() }), O.bind(t, "click", function () { u.innerHTML = JSON.stringify(i.getSaveObject(), void 0, 2), ki.show(), u.focus(), u.select() }), O.bind(n, "click", function () { i.save() }), O.bind(r, "click", function () { var d = prompt("Enter a new preset name."); d && i.saveAs(d) }), O.bind(s, "click", function () { i.revert() }) } function I_(i) { var e = void 0; i.__resize_handle = document.createElement("div"), Y.extend(i.__resize_handle.style, { width: "6px", marginLeft: "-3px", height: "200px", cursor: "ew-resize", position: "absolute" }); function t(s) { return s.preventDefault(), i.width += e - s.clientX, i.onResize(), e = s.clientX, !1 } function n() { O.removeClass(i.__closeButton, Qe.CLASS_DRAG), O.unbind(window, "mousemove", t), O.unbind(window, "mouseup", n) } function r(s) { return s.preventDefault(), e = s.clientX, O.addClass(i.__closeButton, Qe.CLASS_DRAG), O.bind(window, "mousemove", t), O.bind(window, "mouseup", n), !1 } O.bind(i.__resize_handle, "mousedown", r), O.bind(i.__closeButton, "mousedown", r), i.domElement.insertBefore(i.__resize_handle, i.domElement.firstElementChild) } function $s(i, e) { i.domElement.style.width = e + "px", i.__save_row && i.autoPlace && (i.__save_row.style.width = e + "px"), i.__closeButton && (i.__closeButton.style.width = e + "px") } function wr(i, e) { var t = {}; return Y.each(i.__rememberedObjects, function (n, r) { var s = {}, a = i.__rememberedObjectIndecesToControllers[r]; Y.each(a, function (o, l) { s[l] = e ? o.initialValue : o.getValue() }), t[r] = s }), t } function N_(i) { for (var e = 0; e < i.__preset_select.length; e++)i.__preset_select[e].value === i.preset && (i.__preset_select.selectedIndex = e) } function dc(i) { i.length !== 0 && R_.call(window, function () { dc(i) }), Y.each(i, function (e) { e.updateDisplay() }) } var O_ = Qe; class F_ { constructor(e, t) { this.gui = new O_, this.optionsThresholds = { height: 0, color: 0, apply: function () { let a = this.height, o = this.color; t.list.forEach(l => { l.originalScaleY >= a && (l.material[0].color.set(o), l.material[1].color.set(o), l.material[2].color.set(o), l.material[3].color.set(o), l.material[4].color.set(o), l.material[5].color.set(o)) }) } }, this.optionsHeightMetaphor = { scale: 100, normalize: 100 }; let n = this.gui.addFolder("Thresholds"); n.add(this.optionsThresholds, "height", 0, t.getHighestBuilding()).name("Building Height"), n.addColor(this.optionsThresholds, "color").name("Color"), n.add(this.optionsThresholds, "apply").name("Apply!"), n.open(); let r = this.gui.addFolder("Metaphors"); r.open(); let s = r.addFolder("Height"); s.add(this.optionsHeightMetaphor, "scale", 1, 200).name("Scale (%)").onChange(a => { let o = a / 100 / (t.getHighestBuilding() / 100), l = this.optionsHeightMetaphor.normalize / 100; this.calculateHeightMetaphor(o, l, t) }), s.add(this.optionsHeightMetaphor, "normalize", 0, 200).name("Normalize (%)").onChange(a => { let o = this.optionsHeightMetaphor.scale / 100 / (t.getHighestBuilding() / 100), l = a / 100; this.calculateHeightMetaphor(o, l, t) }), s.open() } getGui() { return this.gui } calculateHeightMetaphor(e, t, n) { let r = n.getHeightMean() * e; n.list.forEach(s => { let a = s.originalScaleY * e; a > r ? (s.scale.y = r + Math.pow(a - r, t), s.scale.y = Math.pow(a, t)) : (s.scale.y = r - Math.pow(r - a, t), s.scale.y = Math.pow(a, t)), s.position.y = s.scale.y / 2 + .1 }) } } class B_ { constructor(e, t, n, r) { this.addMouseInteractions(e, t, n, r), this.mousePosition = null } addMouseInteractions(e, t, n, r) { r.getRenderer().domElement.addEventListener("mousedown", o => { const l = new De; l.x = o.clientX / window.innerWidth * 2 - 1, l.y = -(o.clientY / window.innerHeight) * 2 + 1, this.mousePosition = l }), r.getRenderer().domElement.addEventListener("mouseup", o => { const l = new De; if (l.x = o.clientX / window.innerWidth * 2 - 1, l.y = -(o.clientY / window.innerHeight) * 2 + 1, l.x === this.mousePosition.x && l.y === this.mousePosition.y) { const c = new tl; c.setFromCamera(l, t); const u = c.intersectObjects(n.children); for (const d of u) if (d.object.geometry.type === "BoxGeometry" && d.object.visible) { let f = {}; d.object instanceof At ? f = { buildingId: d.object.buildingId, buildingName: d.object.buildingName, buildingGroupingPath: d.object.buildingGroupingPath, buildingData: d.object.buildingData } : f = { nodeName: d.object.parent.nodeName }; const m = e.getElementById("frame-info"); m.style.display = "block"; const _ = e.getElementById("info-panel-div"); for (; _.firstChild;)_.removeChild(_.firstChild); for (const g in f) { let h = e.createElement("p"); h.innerHTML = `<strong>${g}:</strong><br>${f[g]}`, _.appendChild(h) } break } } }); let s, a; r.getRenderer().domElement.addEventListener("mousemove", o => { let l = e.getElementsByClassName("model-tree-element"); for (let f of l) f.style.color = "black"; const c = new De; c.x = o.clientX / window.innerWidth * 2 - 1, c.y = -(o.clientY / window.innerHeight) * 2 + 1; const u = new tl; u.setFromCamera(c, t); const d = u.intersectObjects(n.children); s != null && (s.object instanceof At ? (s.object.material[0].color.set(a), s.object.material[1].color.set(a), s.object.material[3].color.set(a), s.object.material[4].color.set(a), s.object.material[5].color.set(a)) : s.object.material.color.set(a), s = null); for (const f of d) if (f.object.geometry.type === "BoxGeometry" && f.object.visible) { if (s = f, s.object instanceof At ? a = new oe(f.object.material[0].color) : a = new oe(f.object.material.color), f.object instanceof At) { let m = f.object.material[0].color; m.r *= 1.4, m.g *= 1.4, m.b *= 1.4, f.object.material[0].color.set(m), f.object.material[1].color.set(m), f.object.material[3].color.set(m), f.object.material[4].color.set(m), f.object.material[5].color.set(m) } else { let m = f.object.material.color; m.r *= 1.4, m.g *= 1.4, m.b *= 1.4, f.object.material.color.set(m) } for (let m of l) f.object instanceof At ? m.id === f.object.uuid && (m.style.color = "blue") : m.id === f.object.parent.uuid && (m.children[0].style.color = "blue"); break } }) } } const z_ = (i, e) => { let t = []; if (i.dataType === "java-source-code") { let n = wc(); for (let r in n) { const s = new ul(r); let a = ba(e); n[r].forEach(l => { s.addBuilding(l, "java-source-code", e, a) }); let o = []; s.list.forEach(l => { l.visible = !1, l.buildingData.forEach(c => { c.timestamp == s.timestamp && (l.visible = !0, o.push(l), e.dimension !== void 0 ? l.scale.x = c[e.dimension] * a.dimension : l.scale.x = 1, l.scale.z = l.scale.x, e.height !== void 0 ? l.scale.y = c[e.height] * a.height : l.scale.y = 1, l.position.y = l.scale.y / 2) }) }), s.buildTreeStructureWithList(o), s.putOnScreen(s.baseNode), s.adjustChildrenLayerPositionY(s.baseNode), t.push(s) } } else { const n = new ul; let r = ba(e); i.data.forEach(s => { n.addBuilding(s, i.dataType, e, r) }), n.buildTreeStructure(), n.putOnScreen(n.baseNode), n.adjustChildrenLayerPositionY(n.baseNode), t.push(n) } return t }; let Ks = [], Zs = []; const hc = () => { for (let i of Ks) H_(i.getRenderer()); Ks = [] }, fc = () => { for (let i of Zs) G_(i.getGui()); Zs = [] }, H_ = i => { i.dispose(); let e = document.getElementsByTagName("canvas"); e.length > 0 && e[0].remove() }, G_ = i => { i.destroy() }, k_ = i => { hc(), fc(), pc(i[0]); const e = new i_; document.body.appendChild(e.getRenderer().domElement); const t = new Zm, n = new a_(e.getRenderer()); e.getRenderer().render(t, n.getCamera()), window.onresize = () => { e.getRenderer().setPixelRatio(window.devicePixelRatio), e.getRenderer().setSize(window.innerWidth, window.innerHeight), n.getCamera().aspect = window.innerWidth / window.innerHeight, n.getCamera().updateProjectionMatrix() }; const r = new p_; t.add(r.getAmbientLight()), t.add(r.getDirectionalLight()), t.add(r.getDirectionalLightHelper()), new B_(document, n.getCamera(), t, e), t.add(i[0].baseNode); let s = new F_(t, i[0]); Zs.push(s), i.length === 1 ? eg(i[0]) : Q_(i, t); function a(o) { e.getRenderer().render(t, n.getCamera()) } e.getRenderer().setAnimationLoop(a), Ks.push(e) }, pc = i => { console.log(i); let e = document.getElementById("model-tree"); for (; e.firstChild;)e.removeChild(e.firstChild); let t = [i.baseNode], n = [], r = document.createElement("div"), s = []; for (; t.length > 0;) { let a = t.pop(); n.push(a), a.children.filter(u => u instanceof Sn || u instanceof At).forEach(u => { t.push(u) }); let l = document.createElement("div"); l.classList.add("model-tree-element"), l.id = a.uuid; let c = document.createElement("input"); if (c.type = "color", c.id = l.id, c.value = "#ffffff", a instanceof Sn) { l.type = "plane", l.expanded = "true"; let u = document.createElement("div"); u.classList.add("model-tree-element"), u.style.fontWeight = "bold", a.nodeName.lastIndexOf(".") !== -1 ? u.innerText = "▿ " + a.nodeName.substring(a.nodeName.lastIndexOf(".") + 1) : u.innerText = "▿ " + a.nodeName, u.style.display = "flex", u.style.alignItems = "center", u.appendChild(c), c.addEventListener("input", () => { for (let d of n) d.uuid === c.id && d.children[0].material.color.set(c.value) }), l.appendChild(u) } else l.type = "building", l.style.display = "flex", l.style.alignItems = "center", a.buildingName.lastIndexOf(".") !== -1 ? l.innerText = a.buildingName.substring(a.buildingName.lastIndexOf(".") + 1) : l.innerText = a.buildingName, l.appendChild(c), c.addEventListener("input", () => { for (let u of n) u.uuid === c.id && u instanceof At && u.setBuildingBaseColor(new oe(c.value)) }); if (s.push(l), a.nodeName !== "project_base_node") { for (let u of s) if (u.id === a.parent.uuid) { u.appendChild(l), l.type == "building", l.style.marginLeft = "20px"; break } } else r.appendChild(l); if (l.type === "building" || l.type === "plane") { let u = l; l.type === "plane" && (u = l.childNodes[0]), u.addEventListener("mouseenter", function () { if (a instanceof At) { let d = a.material[0].color; d.r *= 1.4, d.g *= 1.4, d.b *= 1.4, a.material[0].color.set(d), a.material[1].color.set(d), a.material[3].color.set(d), a.material[4].color.set(d), a.material[5].color.set(d), u.style.color = "blue" } else { let d = a.children[0].material.color; d.r *= 1.4, d.g *= 1.4, d.b *= 1.4, a.children[0].material.color.set(d), u.style.color = "blue" } }), u.addEventListener("mouseleave", function () { if (a instanceof At) { let d = a.material[0].color; d.r /= 1.4, d.g /= 1.4, d.b /= 1.4, a.material[0].color.set(d), a.material[1].color.set(d), a.material[3].color.set(d), a.material[4].color.set(d), a.material[5].color.set(d), u.style.color = "black" } else { let d = a.children[0].material.color; d.r /= 1.4, d.g /= 1.4, d.b /= 1.4, a.children[0].material.color.set(d), u.style.color = "black" } }), u.addEventListener("click", d => { if (d.target.type !== "color") if (l.type === "building") console.log(l); else { u.parentElement.expanded = u.parentElement.expanded === "true" ? "false" : "true", u.innerText = u.parentElement.expanded === "true" ? u.innerText.replace("▸", "▿") : u.innerText.replace("▿", "▸"), console.log(u); let f = u.parentElement.children; for (let m = 1; m < f.length; m++)f[m].type === "building" ? f[m].style.display = f[m].style.display === "none" ? "flex" : "none" : f[m].style.display = f[m].style.display === "none" ? "block" : "none" } }) } } return e.appendChild(r), n }, ji = i => { const e = i.getFullYear(), t = String(i.getMonth() + 1).padStart(2, "0"), n = String(i.getDate()).padStart(2, "0"), r = String(i.getHours()).padStart(2, "0"), s = String(i.getMinutes()).padStart(2, "0"), a = String(i.getSeconds()).padStart(2, "0"), o = String(i.getMilliseconds()).padStart(3, "0"); return `${e}-${t}-${n}, ${r}:${s}:${a}:${o}` }, V_ = document.getElementById("button-upload"), W_ = document.getElementById("button-visualize"), X_ = document.getElementById("button-view-data"), Js = document.getElementById("button-clear-data"), Y_ = document.getElementById("button-model-tree"), mc = document.getElementById("view-data"), Cr = document.getElementById("thead"), Rr = document.getElementById("tbody"), Qt = document.getElementById("frame-upload"), en = document.getElementById("frame-visualize"), Ct = document.getElementById("frame-model-tree"), Yt = document.getElementById("frame-info"), yl = document.getElementsByClassName("button-close"), Qs = document.getElementById("dimension-attribute-selection"), ea = document.getElementById("height-attribute-selection"), ta = document.getElementById("color-attribute-selection"), q_ = document.getElementById("button-upload-data"), _c = document.getElementById("alert-success-upload-data"), gc = document.getElementById("alert-success-clear-data"), j_ = document.getElementById("button-alert-close-upload-data"), $_ = document.getElementById("button-alert-close-clear-data"), K_ = document.getElementById("button-start-visualize"), ga = document.getElementById("slider-container"), Jt = document.getElementById("slider-thumb"), bi = document.getElementById("slider"), Hr = document.getElementById("slider-value"); V_.addEventListener("click", () => { en.style.display = "none", Yt.style.display = "none", Ct.style.display = "none", Qt.style.display === "none" || Qt.style.display === "" ? Qt.style.display = "block" : Qt.style.display = "none" }); W_.addEventListener("click", () => { Qt.style.display = "none", Yt.style.display = "none", Ct.style.display = "none", en.style.display === "none" || en.style.display === "" ? en.style.display = "block" : en.style.display = "none" }); X_.addEventListener("click", () => { Qt.style.display = "none", en.style.display = "none", Yt.style.display = "none", Ct.style.display = "none", hc(), fc(), ga.style.display = "none", mc.style.display = "block" }); Y_.addEventListener("click", () => { Qt.style.display = "none", en.style.display = "none", Yt.style.display = "none", Ct.style.display === "none" || Ct.style.display === "" ? Ct.style.display = "block" : Ct.style.display = "none" }); Js.addEventListener("click", () => { Ac(), gc.style.display = "block", $("#alert-success-clear-data").delay(2e3).fadeOut(800), xc() }); for (let i = 0; i < yl.length; i++)yl[i].addEventListener("click", () => { Qt.style.display = "none", en.style.display = "none", Yt.style.display = "none", Ct.style.display = "none" }); document.addEventListener("keydown", i => { i.key === "Escape" && (Qt.style.display = "none", en.style.display = "none", Yt.style.display = "none", Ct.style.display = "none") }); q_.addEventListener("click", i => { i.preventDefault(); const e = document.getElementById("file").files[0]; let t = new FileReader; t.readAsText(e), t.onload = n => { Tc(n.target.result, document.getElementById("file-format").value), Qs.replaceChildren(), ea.replaceChildren(), ta.replaceChildren(), aa().attributeNames.forEach(r => { const s = document.createElement("option"); s.value = r, s.innerText = r, Qs.appendChild(s.cloneNode(!0)), ea.appendChild(s.cloneNode(!0)), ta.appendChild(s.cloneNode(!0)) }), _c.style.display = "block", $("#alert-success-upload-data").delay(2e3).fadeOut(800), Qt.style.display = "none", xc() } }); j_.addEventListener("click", () => { _c.style.display = "none" }); $_.addEventListener("click", () => { gc.style.display = "none" }); K_.addEventListener("click", i => { i.preventDefault(); let e = { dimension: Qs.value, height: ea.value, color: ta.value }; document.getElementById("city-dimension").value, document.getElementById("city-spread").value, en.style.display = "none", mc.style.display = "none"; let t = z_(aa(), e); k_(t) }); let na = 0, ia = 0; Yt.addEventListener("mousedown", i => { let e = Yt.getBoundingClientRect(); na = i.clientX - (e.left + e.width / 2), ia = i.clientY - (e.top + e.height / 2), document.onmouseup = vc, na > e.width / 2 - 17 && ia > e.height / 2 - 17 || (document.onmousemove = Z_) }); let ra = 0, sa = 0; Ct.addEventListener("mousedown", i => { let e = Ct.getBoundingClientRect(); ra = i.clientX - (e.left + e.width / 2), sa = i.clientY - (e.top + e.height / 2), document.onmouseup = vc, ra > e.width / 2 - 17 && sa > e.height / 2 - 17 || (document.onmousemove = J_) }); const vc = i => { document.onmouseup = null, document.onmousemove = null }, Z_ = i => { i.preventDefault(); let e = Yt.getBoundingClientRect(), t = i.clientX - na, n = i.clientY - ia; t = t - e.width / 2 < 0 ? e.width / 2 : t, n = n - e.height / 2 < 0 ? e.height / 2 : n, t = t + e.width / 2 > window.innerWidth ? window.innerWidth - e.width / 2 : t, n = n + e.height / 2 > window.innerHeight ? window.innerHeight - e.height / 2 : n, Yt.style.left = t + "px", Yt.style.top = n + "px" }, J_ = i => { i.preventDefault(); let e = Ct.getBoundingClientRect(), t = i.clientX - ra, n = i.clientY - sa; t = t - e.width / 2 < 0 ? e.width / 2 : t, n = n - e.height / 2 < 0 ? e.height / 2 : n, t = t + e.width / 2 > window.innerWidth ? window.innerWidth - e.width / 2 : t, n = n + e.height / 2 > window.innerHeight ? window.innerHeight - e.height / 2 : n, Ct.style.left = t + "px", Ct.style.top = n + "px" }, Q_ = (i, e) => { let t = 0, n = i[t], r = new Date(i[t].timestamp), a = new Date(i[i.length - 1].timestamp) - r; Hr.textContent = ji(r), ga.style.display = "block"; let o = !1, l = 0; Jt.addEventListener("mousedown", c => { o = !0, l = c.clientX - Jt.getBoundingClientRect().left }), document.addEventListener("mouseup", () => { o = !1, l = 0 }), document.addEventListener("mousemove", c => { if (o) { const u = c.clientX - bi.getBoundingClientRect().left - l; let d = Math.min(bi.clientWidth - Jt.clientWidth, Math.max(0, u)); Jt.style.left = d + "px"; let f = d / (bi.clientWidth - Jt.clientWidth), m = new Date(r.getTime() + parseInt(f * a)); Hr.textContent = ji(m); const g = i.filter(p => new Date(p.timestamp) <= m).reduce((p, b) => new Date(b.timestamp) > new Date(p.timestamp) ? b : p, i[0]), h = i.findIndex(p => p === g); h !== t && (t = h, e.remove(...e.children.filter(p => p instanceof Sn)), n = g, e.add(n.baseNode)), pc(n.baseNode) } }) }, eg = i => { i.list.forEach(a => { a.visible = !1 }); const e = i.getLowestTimestamp(), n = i.getHighestTimestamp() - e; Hr.textContent = ji(e), ga.style.display = "block"; let r = !1, s = 0; Jt.addEventListener("mousedown", a => { r = !0, s = a.clientX - Jt.getBoundingClientRect().left }), document.addEventListener("mouseup", () => { r = !1, s = 0 }), document.addEventListener("mousemove", a => { if (r) { const o = a.clientX - bi.getBoundingClientRect().left - s; let l = Math.min(bi.clientWidth - Jt.clientWidth, Math.max(0, o)); Jt.style.left = l + "px"; let c = l / (bi.clientWidth - Jt.clientWidth), u = new Date(e.getTime() + parseInt(c * n)); Hr.textContent = ji(u); let d = 0, f = 0; for (let m of i.list) { let _ = 0, g = 0; for (let h of m.buildingData) _ += 1, g += parseInt(h.avgEyeFixationDuration); _ > d && (d = _), g > f && (f = g) } for (let m of i.list) { let _ = 0, g = 0; for (let b of m.buildingData) new Date(b.timestamp) <= u && (_ += parseInt(b.avgEyeFixationDuration), g += 1); m.visible = _ > 0; let h = m.buildingBaseColor.clone(), p = _ / f; h.r = h.r * p, h.g = h.g * p, h.b = h.b * p, m.setBuildingColor(h), h = m.material[2].color, p = g / d * (50 / 100), h.r = p, h.g = p, h.b = p, m.material[2].color.set(h) } } }) }, xc = () => { for (; Cr.firstChild;)Cr.removeChild(Cr.firstChild); for (; Rr.firstChild;)Rr.removeChild(Rr.firstChild); let i = aa(), e = document.createElement("tr"); i.attributeNames.forEach(t => { let n = document.createElement("th"); n.innerText = t, e.appendChild(n) }), Cr.appendChild(e), i.data.forEach(t => { e = document.createElement("tr"); for (let n in t) { let r = document.createElement("td"); n === "timestamp" ? r.innerText = ji(t[n]) : r.innerText = t[n], e.appendChild(r) } Rr.appendChild(e) }), i.data.length > 0 ? Js.style.display = "block" : Js.style.display = "none", $("#table-data").DataTable() };
